        ...
        <div class="col-md-12">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    ...
                    <form class="form-horizontal" action="{{route('create-new-product')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="sub_category_id" class="form-control" id="" required>
