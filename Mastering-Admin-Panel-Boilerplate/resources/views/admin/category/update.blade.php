    ...
    <div class="py-5">
        <div class="ibox">
            ...
            <div class="ibox-body">
                ...
                @endif
                <form action="{{route('update.category',['id'=>$category->id])}}" method="post" class="form-horizontal" id="form-sample-1" novalidate="novalidate">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" type="text" name="category_description" rows="5" cols="5">{{$category->category_description}}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
